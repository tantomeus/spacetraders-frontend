    ...
    return <section className="w-[70%] mx-auto">
        <div className="text-sm">
            ...
            <div className="p-2">
                ...
                <p>You need to send your ship with a cargo capacity greater than nothing to the planet with <span className="text-amber-600">marketplace</span>.</p>
        ...
        <div className="text-sm">
            ...
            <div className="p-2">
                ...
                <ul className="text-left">
                    <li>1. CRUISE - Cruise flight mode is the default mode for all ships. It consumes fuel at a normal rate and travels at a normal speed.</li>
                    <li>2. BURN - Burn flight mode consumes fuel at a faster rate and travels at a faster speed.</li>
                    <li>3. DRIFT - Drift flight mode consumes the least fuel and travels at a much slower speed. Drift mode is useful when your ship has run out of fuel and you need to conserve what little fuel you have left.</li>
                    <li>4. STEALTH - Stealth flight mode runs with systems at a minimum, making it difficult to detect. It consumes fuel at a normal rate but travels at a reduced speed.</li>
                </ul>
            </div>
                ...
                <div className="flex items-center gap-8 mt-2">
                    <div className="flex flex-col items-center">
                        ...
                        <div className="relative flex justify-center items-center h-20 w-20 mt-2">
                            <FaHelicopterSymbol className="absolute h-full w-full bg-stone-400 fill-amber-600 rounded-full p-2"/>
        ...
        <div className="text-sm">
            ...
            <div className="p-2">
                ...
                <p>Go to the contracts page and accept the contracts you like. The “Accept” button will become a “Fulfill” button and will be inactive until you fulfill the conditions</p>
            </div>
        </div>
        ...
        <div className="text-sm">
            ...
            <div className="p-2">
                ...
                <p>Buy a mining drone and send it to an asteroid field. To mine, you need to undock your drone.</p>
            </div>
        </div>
        ...
        <div className="text-sm">
            ...
            <div className="p-2">
                ...
                <p>The API is in alpha version, so factions, like many other features, are not yet fully featured. But you can choose your faction.</p>
            </div>
        </div>
  </section>
}
